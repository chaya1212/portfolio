<template>
  <section class="section site-portfolio py-5">
    <div class="container">
      <div class="row mb-5 align-items-center">
        <div class="col-md-12 col-lg-6 mb-4 mb-lg-0" data-aos="fade-up">
          <h2>Hey, I'm chaya</h2>
          <p class="mb-0">UIUX | Photography | Graphics</p>
        </div>
        <div
        ...
        >
          <div id="filters" class="filters">
            <a href="#" class="filter-link" @click.prevent="filterItems('All')">All</a>
            <a href="#" class="filter-link" @click.prevent="filterItems('Web')">Web</a>
            <a href="#" class="filter-link" @click.prevent="filterItems('Design')"
              >Design</a
            >
            <a href="#" class="filter-link" @click.prevent="filterItems('Motion')"
              >Motion</a
            >
            <a href="#" class="filter-link" @click.prevent="filterItems('Photography')"
              >Photography</a
            >
          </div>
        </div>
      ...
      <div
        ...
        data-aos-delay="200"
      >
        <PortfolioItem v-for="item in filteredItems" :key="item.id" :item="item" />
      </div>
    </div>
  </section>
</template>
...
const portfolioItems = ref([
  ...
  },
  {
    ...
    title: "企業形象官網：醫療公關公司",
    description: "",
    imageUrl: "static/images/web/web_03.png",
    link: "/portfolio/12",
  },
]);
...
const filteredItems = computed(() => {
  ...
  return portfolioItems.value.filter((item) => item.category === currentFilter.value);
});
